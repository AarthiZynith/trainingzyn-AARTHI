codeunit 50131 "PostedBeginningTextHandler"
{
    ...
    var
        SourceBuffer: Record SalesInvoiceSubpageExt
    ;
        TargetBuffer: Record SalesInvoiceSubpageExt;
        NewLineNo: Integer;
        SelectionType: Enum BeginEndText;
    begin
    ...
    local procedure GetNextLineNo(Buffer: Record SalesInvoiceSubpageExt; DocNo: Code[20]; CustNo: Code[20]; Sel: Enum BeginEndText): Integer
    var
        MaxLineNo: Integer;
    begin
        Buffer.Reset();
    ...
    var
        ...
        LastSoldPrice: Record HighestSalesPrice;
    begin
