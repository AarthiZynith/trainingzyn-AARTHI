table 50232 Zyn_ExpenseClaimTable
{
    ...
    //default setting the Status into PendingApproval
    trigger OnInsert()
    begin
    ...
    var
        ExpenseClaim: Record Zyn_ExpenseClaimTable;
    ...
    var
        ...
        ClaimRec: Record Zyn_ExpenseClaimTable;
        Total: Decimal;
    ...
    begin
        ...
        //ClaimRec.SetRange(ClaimDate, CalcDate('<-CY>', ClaimDate)); // Optional: current year
        //Total := 0;
